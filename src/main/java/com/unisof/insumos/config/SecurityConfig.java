    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/", "/index.html", "/login.html", "/verificar-token.html", "/recuperar-contrasena.html", "/panel-admin.html", "/personal.html", "/terminos-y-condiciones.html", "/ventas.html", "/compras.html", "/css/**", "/js/**", "/images/**").permitAll()
